...
\begin{table}[h]
  ...
  \begin{center}
    \begin{tabular}{ccl}
      ...
      \\ $\hat{\DiscFac}_{s},\LivPrb_{s}$ & figure \ref{fig:TimeVaryingParam} & Cagetti~\citeyearpar{cagettiWprofiles}
