...
\vEndStget(\aNrm_{t}) & = \DiscFac \vBegStgetp(\underbrace{\kNrm_{t+1}}_{=\aNrm_{t}}) \label{eq:vEndStget}
      \end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/vEndStget}\unskip
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotcTm1Simple}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotVTm1Simple}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotOTm1RawVSInt}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotComparecTm1AB}}
  \caption{$\cFunc_{T-1}({m}_{T-1})$ (solid) versus $\Alt{\cFunc}_{T-1}({m}_{T-1})$ (dashed)}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotuPrimeVSOPrime}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotOPRawVSFOC}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotcTm1ABC}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/GothVInvVSGothC}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/GothVVSGothCInv}}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/PlotComparecTm1AD}}
  \caption{$\cFunc_{T-1}({m}_{T-1})$ (solid) versus $\Alt{\cFunc}_{T-1}({m}_{T-1})$ (dashed)}
...
\begin{figure}
  \centerline{\includegraphics{./Figures/GothVInvVSGothCEEE}}
