...
% Sections = _sectn-
\input{_sectn-titlepage-input}
\input{_sectn-introduction-input}
\input{_sectn-the-problem-input}
%\input{./.resources/latex/bibliography-blend}\end{document}\endinput % \endinput prevents any processing of subsequent stuff01
\input{_sectn-normalization-input}
\input{_sectn-notation-input}
\input{_sectn-the-usual-theory-input}
\input{_sectn-solving-the-next-input}
%\MoM{\input{_sectn-method-of-moderation-input}}{}
\input{_sectn-the-infinite-horizon-input}
\input{_sectn-multiple-control-variables-input}
\input{_sectn-structural-estimation-input}
\input{_sectn-conclusion-input}
