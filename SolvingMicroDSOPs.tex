...
\subfile{sec_titlepage}
%\input{Resources/LaTeXInputs/bibliography_blend}\end{document}\endinput % \endinput prevents any processing of subsequent stuff
\subfile{sec_introduction}
\subfile{sec_the-problem}
\subfile{sec_normalization}
\subfile{sec_notation}
%\subfile{sec_the-usual-theory}
\subfile{sec_solving-the-next}
%\MoM{\subfile{sec_method-of-moderation}}{}
% Habits go here: \input{./Subfiles-private/Habits}
\subfile{sec_the-infinite-horizon}
\subfile{sec_multiple-control-variables}
\subfile{sec_structural-estimation}
