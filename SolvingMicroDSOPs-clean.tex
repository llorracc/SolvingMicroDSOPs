...
% \usepackage{\LaTeXInputs/local-macros}

% \input{\LaTeXInputs/local-packages} % LaTeX config in Resources/LaTeXInputs
\usepackage{./Resources/LaTeXInputs/local-packages} % LaTeX config in Resources/LaTeXInputs
% \providecommand{\onlyinsubfile}[1]{}\renewcommand{\onlyinsubfile}[1]{}
% \providecommand{\notinsubfile}[1]{#1}\renewcommand{\notinsubfile}[1]{#1}
...
\bibliographystyle{./Resources/texmf-local/bibtex/bst/econtex}
\begin{document}
...
\noindent  Note: The GitHub repo {\texttt{\href{https://github.com/llorracc/SolvingMicroDSOPs}{SolvingMicroDSOPs}}} associated with this document contains python code that produces all results, from scratch, except for the last section on indirect inference.  The numerical results have been confirmed by showing that the answers that the raw python produces correspond to the answers produced by tools available in the \href{https://econ-ark.org}{Econ-ARK} toolkit, more specifically those in the {\HARKrepo} which has full {\HARKdocs}.  The MSM results at the end have have been superseded by tools in the {\texttt{\href{https://github.com/llorracc/EstimatingMicroDSOPs}{EstimatingMicroDSOPs repo}}}.
...
\begin{footnotesize}
  \begin{center}
    \begin{tabbing}
      \texttt{~~~~PDF:~} \= \= {\texttt{\href{https://github.com/llorracc/SolvingMicroDSOPs/blob/master/SolvingMicroDSOPs.pdf}{https://github.com/llorracc/SolvingMicroDSOPs/blob/master/SolvingMicroDSOPs.pdf}}} \\
      \texttt{~Slides:~} \> \> {\texttt{\href{https://github.com/llorracc/SolvingMicroDSOPs/blob/master/SolvingMicroDSOPs-Slides.pdf}{https://github.com/llorracc/SolvingMicroDSOPs/blob/master/SolvingMicroDSOPs-Slides.pdf}}} \\
      \texttt{~~~~Web:~} \> \> {\texttt{\href{https://llorracc.github.io/SolvingMicroDSOPs}{https://llorracc.github.io/SolvingMicroDSOPs}}} \\
      \texttt{~~~Code:~} \> \> {\texttt{\href{https://github.com/llorracc/SolvingMicroDSOPs/tree/master/Code}{https://github.com/llorracc/SolvingMicroDSOPs/tree/master/Code}}} \\
      \texttt{Archive:~} \> \> {\texttt{\href{https://github.com/llorracc/SolvingMicroDSOPs}{https://github.com/llorracc/SolvingMicroDSOPs}}} \\
