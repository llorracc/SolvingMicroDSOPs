...
CRRA_start = 4.0  # Initial guess of CRRA (\CRRA) during estimation
DiscFacAdj_start = 0.99  # Initial guess of DiscFacAdj (\DiscFac adjustment) during estimation
DiscFacAdj_bound = [
    0.0001,
    15.0,
]  # Bounds for DiscFacAdj; if violated, objective function returns "penalty value"
CRRA_bound = [
    0.0001,
    15.0,
]  # Bounds for CRRA; if violated, objective function returns "penalty value"
