...
\documentclass[titlepage,abstract, headings=optiontotocandhead]{Resources/texmf-local/tex/latex/econtex}

\usepackage{Resources/LaTeXInputs/local}            % LaTeX config in Resources/LaTeXInputs
...
\notinsubfile{\input{Resources/LaTeXInputs/bibliography_blend}} \end{document}\endinput
subject to
