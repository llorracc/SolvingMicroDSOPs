...
\documentclass[titlepage,abstract, headings=optiontotocandhead]{\econtex}

\usepackage{\local}            % LaTeX config in Resources/LaTeXInputs
\usepackage{cctwMoM-options} % booleans that control whether certain features are on or off
