...
#
# This notebook reproduces all the figures generated by Mathematica (except for those associated with the "method of moderation") in Chris's Carroll's [SolvingMicroDSOP lecture notes](https://llorracc.github.io/SolvingMicroDSOPs/) using Python.   
#
...
# theta2 = DiscreteApproximationToMeanOneLogNormal(N=theta_grid_N,sigma=sigma)
## (both are correct)
...
# %% code_folding=[32, 64, 96, 99, 115, 117, 128, 143]
...
class GothicMC(Gothic):  ## inheriting from Gothic class
    ...
    def Va_Tminus1(self, a):
        ...
        Va_func = lambda tinc_shk, rreturn: (
            ...
            (self.R + (rreturn - self.R) * varsigma_opt) * a / self.Gamma[-1] + tinc_shk
        )
