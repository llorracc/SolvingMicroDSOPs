...
ExtrapProblemSolvedPlot = Plot[{\[ScriptC]\[Digamma][m,1]-\[ScriptC]Tm1Raw[m],\[ScriptC]\[Digamma][m,1]-\[ScriptC][m,1]}
,{m,1,30}
...
ExportFigs["ExtrapProblemSolvedPlot",ExtrapProblemSolvedPlot];
Print[ExtrapProblemSolvedPlot];
