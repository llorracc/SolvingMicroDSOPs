...
$do_cd = 1;
$clean_ext = "bbl nav out snm dvi idv mk4 css cfg tmp xref 4tc out aux log fls fdb_latexmk synctex.gz toc svg png html 4ct ps dep out.ps upa upb title 4ct";
$bibtex_use=2;
$pdf_mode = 1;
$out_dir = '.';
$rc_report = 1;
