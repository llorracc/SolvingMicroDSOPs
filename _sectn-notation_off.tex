...
The connector, $\vArvlPrdNxt$, and $\DiscFac$ together form the \textit{builder-spec} for this creation: the purely mathematical information the builder needs.  In general a builder-spec collects whatever transition functions, operators, and other formulas its builder requires.
...
{\interval} {\prd} is solved once we have constructed $\vArvlPrd$.\footnote{We consider a single-{\stg} problem here; multi-stage notation is developed below.}
